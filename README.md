...
## 
1. Run our python controller without bluetooth commissioning :
    ```sh
...
2. Run our tv-app with default Pin : `20202021` 
                               Discriminator : `3840`
                               Manual Paring Code : `749701123365521327694`:
    ```sh
